...
# 9.  set -o functrace   :::
# 10. set -o allexport   ::: Automatically mark variables and functions which are modified or created for export to the environment of subsequent commands.
# 11. set -o braceexpand ::: The shell performs brace expansion (see Brace Expansion above).  This is on by default.
